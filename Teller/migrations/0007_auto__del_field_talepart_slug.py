...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TalePart.slug'
        db.delete_column(u'Teller_talepart', 'slug')


    def backwards(self, orm):
        # Adding field 'TalePart.slug'
        db.add_column(u'Teller_talepart', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=1, max_length=150, unique=True),
                      keep_default=False)
