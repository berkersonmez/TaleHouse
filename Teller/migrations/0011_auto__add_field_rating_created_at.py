...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rating.created_at'
        db.add_column(u'Teller_rating', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 1, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rating.created_at'
        db.delete_column(u'Teller_rating', 'created_at')
    ...
    models = {
        ...
        u'Teller.rating': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
