...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rating'
        db.create_table(u'Teller_rating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratings', to=orm['Teller.Profile'])),
            ('tale', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratings', to=orm['Teller.Tale'])),
            ('rating', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=2, decimal_places=1)),
        ))
        db.send_create_signal(u'Teller', ['Rating'])

        # Adding field 'Tale.overall_rating'
        db.add_column(u'Teller_tale', 'overall_rating',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'Teller_rating')

        # Deleting field 'Tale.overall_rating'
        db.delete_column(u'Teller_tale', 'overall_rating')
