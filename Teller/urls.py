...
urlpatterns = patterns('',
                       ...
                       url(r'^tale/variable/add/(?P<tale_slug>[\w-]+)$', views.tale_add_variable, name='tale_add_variable'),
                       url(r'^tale/variable/edit/(?P<tale_variable_id>[\d-]+)$', views.tale_edit_variable, name='tale_edit_variable'),
                       url(r'^tale/variable/delete/(?P<tale_variable_id>[\d-]+)$', views.tale_delete_variable,
                           name='tale_delete_variable'),
                       ...
                       url(r'^tale/enable/(?P<tale_part_id>[\d-]+)$', views.tale_activate_part, name='tale_activate_part'),
                       url(r'^tale/comment/(?P<tale_part_id>[\d-]+)$', views.tale_add_comment, name='tale_add_comment'),
                       ...
                       url(r'^tale/graph/edit/(?P<tale_slug>[\w-]+)$', views.tale_edit_graph, name='tale_edit_graph'),
                       url(r'^tale/graph/apply/(?P<tale_slug>[\w-]+)$', views.tale_apply_graph,
                           name='tale_apply_graph'),
