...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field followed_users on 'Profile'
        m2m_table_name = db.shorten_name(u'Teller_profile_followed_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_profile', models.ForeignKey(orm[u'Teller.profile'], null=False)),
            ('to_profile', models.ForeignKey(orm[u'Teller.profile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_profile_id', 'to_profile_id'])


    def backwards(self, orm):
        # Removing M2M table for field followed_users on 'Profile'
        db.delete_table(db.shorten_name(u'Teller_profile_followed_users'))
    ...
    models = {
        ...
        u'Teller.profile': {
            ...
            'followed_users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'followed_users_rel_+'", 'null': 'True', 'to': u"orm['Teller.Profile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
