...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'Teller_profile', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug', max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.slug'
        db.delete_column(u'Teller_profile', 'slug')
    ...
    models = {
        ...
        u'Teller.rating': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
