...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Teller_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=150)),
        ))
        db.send_create_signal(u'Teller', ['Profile'])

        # Adding M2M table for field selected_links on 'Profile'
        m2m_table_name = db.shorten_name(u'Teller_profile_selected_links')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'Teller.profile'], null=False)),
            ('talelink', models.ForeignKey(orm[u'Teller.talelink'], null=False))
        ))
        db.create_unique(m2m_table_name, ['profile_id', 'talelink_id'])


        # Changing field 'Tale.user'
        db.alter_column(u'Teller_tale', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Teller.Profile']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'Teller_profile')

        # Removing M2M table for field selected_links on 'Profile'
        db.delete_table(db.shorten_name(u'Teller_profile_selected_links'))


        # Changing field 'Tale.user'
        db.alter_column(u'Teller_tale', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Teller.User']))
