...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaleLinkPrecondition'
        db.create_table(u'Teller_talelinkprecondition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tale_link', self.gf('django.db.models.fields.related.ForeignKey')(related_name='preconditions', to=orm['Teller.TaleLink'])),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('condition', self.gf('django.db.models.fields.CharField')(default='LT', max_length=2)),
            ('tale_variable', self.gf('django.db.models.fields.related.ForeignKey')(related_name='preconditions', to=orm['Teller.TaleVariable'])),
        ))
        db.send_create_signal(u'Teller', ['TaleLinkPrecondition'])

        # Adding model 'TaleLinkConsequence'
        db.create_table(u'Teller_talelinkconsequence', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tale_link', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consequences', to=orm['Teller.TaleLink'])),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('consequence', self.gf('django.db.models.fields.CharField')(default='AD', max_length=2)),
            ('tale_variable', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consequences', to=orm['Teller.TaleVariable'])),
        ))
        db.send_create_signal(u'Teller', ['TaleLinkConsequence'])


    def backwards(self, orm):
        # Deleting model 'TaleLinkPrecondition'
        db.delete_table(u'Teller_talelinkprecondition')

        # Deleting model 'TaleLinkConsequence'
        db.delete_table(u'Teller_talelinkconsequence')
    ...
    models = {
        ...
        u'Teller.talelinkconsequence': {
            'Meta': {'object_name': 'TaleLinkConsequence'},
            'consequence': ('django.db.models.fields.CharField', [], {'default': "'AD'", 'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tale_link': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'consequences'", 'to': u"orm['Teller.TaleLink']"}),
            'tale_variable': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'consequences'", 'to': u"orm['Teller.TaleVariable']"}),
            'value': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'Teller.talelinkprecondition': {
            'Meta': {'object_name': 'TaleLinkPrecondition'},
            'condition': ('django.db.models.fields.CharField', [], {'default': "'LT'", 'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tale_link': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'preconditions'", 'to': u"orm['Teller.TaleLink']"}),
            'tale_variable': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'preconditions'", 'to': u"orm['Teller.TaleVariable']"}),
            'value': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'Teller.talepart': {
