...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaleLink.tale'
        db.add_column(u'Teller_talelink', 'tale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Teller.Tale']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaleLink.tale'
        db.delete_column(u'Teller_talelink', 'tale_id')
