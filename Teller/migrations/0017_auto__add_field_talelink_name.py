...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaleLink.name'
        db.add_column(u'Teller_talelink', 'name',
                      self.gf('django.db.models.fields.CharField')(default='UNNAMED', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaleLink.name'
        db.delete_column(u'Teller_talelink', 'name')
